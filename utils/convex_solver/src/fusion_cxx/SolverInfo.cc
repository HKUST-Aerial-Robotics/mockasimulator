...
std::vector<std::string> SolverInfo::iinfnames{ "anaProNumCon",
                                                "anaProNumConEq",
                                                "anaProNumConFr",
                                                "anaProNumConLo",
                                                "anaProNumConRa",
                                                ...
                                                "solItrSolsta",
                                                "stoNumARealloc" };
std::vector<std::string> SolverInfo::liinfnames{ "biCleanDualDegIter",
                                                 "biCleanDualIter",
                                                 ...
                                                 "rdNumanz",
                                                 "rdNumqnz" };
MSKdinfiteme SolverInfo::dinfsyms[] = {
...
MSKiinfiteme SolverInfo::iinfsyms[] = { MSK_IINF_ANA_PRO_NUM_CON,
...
MSKliinfiteme SolverInfo::liinfsyms[] = { MSK_LIINF_BI_CLEAN_DUAL_DEG_ITER,
                                          ...
                                          MSK_LIINF_RD_NUMQNZ };
bool
SolverInfo::getdouinf(const std::string& infname, MSKdinfiteme& key)
{
...
bool
SolverInfo::getintinf(const std::string& infname, MSKiinfiteme& key)
{
...
bool
SolverInfo::getlintinf(const std::string& infname, MSKliinfiteme& key)
{
